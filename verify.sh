...
check "example submission" "$TARGET/Test-report-results/examples/tesla-us433700/submission.md"
check "example quickstart prompt" "$TARGET/Test-report-results/examples/tesla-us433700/quickstart-prompt.md"
check "example report v1.6" "$TARGET/Test-report-results/examples/tesla-us433700/report-tesla-us433700-e2e-v16.md"
...
check "v1.7 tests" "$TARGET/Test-report-results/tests_v17/test_us8527057_acceptance.py"
check "v1.8 state machine tests" "$TARGET/Test-report-results/tests_v17/test_state_machine.py"
check "v1.8 coverage tests" "$TARGET/Test-report-results/tests_v17/test_coverage.py"
...
if command -v pytest >/dev/null 2>&1; then
  if PYTHONPATH="$TARGET" pytest "$TARGET/Test-report-results/tests_v17" -q; then
